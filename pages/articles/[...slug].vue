...
const fullPath = useRoute().fullPath; // Guarda la ruta completa actual
const article = await useAsyncStoryblok(fullPath ? fullPath : "home", {
  version: "draft",
});
